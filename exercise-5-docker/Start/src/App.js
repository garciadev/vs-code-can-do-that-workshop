...
class App extends Component {
  constructor() {
    super();
    this.state = { color: "", pastColors: [], bulbColor: "" };
  }
  ...
  async componentDidMount() {
    ...
    connection.on("colorChanged", hex => {
      // add a color circle
      this.setState({
        pastColors: [...this.state.pastColors, hex],
        bulbColor: hex
      });
    });
  ...
  async updateColor() {
    await fetch(`/api/setColor?color=${this.state.color}`);
    this.setState({ bulbColor: this.state.color });
  }
  ...
  handleUpdateColorFromPalette = async color => {
          ...
          <div className="columns">
            <div className="column">
              <div className="columns is-mobile is-multiline">
                {this.state.pastColors.map((value, index) => {
                  return (
                    <div className="column is-one-quarter">
                      <div
                        className="pastColor"
                        style={{ backgroundColor: `#${value}` }}
                        onClick={this.handleUpdateColorFromPalette.bind(
                          this,
                          value
                        )}
                      />
